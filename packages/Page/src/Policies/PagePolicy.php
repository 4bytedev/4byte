...
namespace Packages\Page\Policies;
...
class PagePolicy
{
    ...
    {
        if ($user->can('force_delete_any_page')) {
            return true;
        }
    ...
    {
        if ($user->can('replicate_any_page')) {
            return true;
        }
