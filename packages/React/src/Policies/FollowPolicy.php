...
class FollowPolicy
{
    ...
    public function view(User $user, Follow $follow): bool
    {
        ...
        return $user->can('view_follow') && $follow->user_id === $user->id;
    }
    ...
    public function update(User $user, Follow $follow): bool
    {
        ...
        return $user->can('update_follow') && $follow->user_id === $user->id;
    }
    ...
    public function delete(User $user, Follow $follow): bool
    {
        ...
        return $user->can('delete_follow') && $follow->user_id === $user->id;
    }
    ...
    public function forceDelete(User $user, Follow $follow): bool
    {
        ...
        return $user->can('force_delete_follow') && $follow->user_id === $user->id;
    }
    ...
    public function restore(User $user, Follow $follow): bool
    {
        ...
        return $user->can('restore_follow') && $follow->user_id === $user->id;
    }
     ...
     */
    public function replicate(User $user, Follow $follow): bool
    {
        if ($user->can('replicate_any_follow')) {
            return true;
        }

        return $user->can('replicate_follow') && $follow->user_id === $user->id;
    }
