...
class SeoService
{
    ...
    public function getUserSEO(UserData $user, UserProfileData $profile)
    {
    ...
    public function getArticleSEO(ArticleData $article, UserData $user)
    {
    ...
    public function getEntrySEO(EntryData $entry, UserData $user)
    {
        $schema = Schema::article()
    ...
    public function getPageSEO(PageData $page, UserData $user)
    {
        $schema = Schema::webPage()
            ->headline($page->title)
    ...
    public function getNewsSEO(NewsData $news, UserData $user)
    {
    ...
    public function getTagSeo(TagData $tag, TagProfileData $profile)
    {
