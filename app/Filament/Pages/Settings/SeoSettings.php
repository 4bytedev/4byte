    ...
    public static function get()
    {
        return Forms\Components\Tabs\Tab::make(__('SEO Settings'))
            ...
            ->schema([
                ...
                Forms\Components\Grid::make()
                    ->schema([
                        Forms\Components\TextInput::make('seoSettings.google_analytics_id')
                            ->label(__('Google Analytics ID')),
                        Forms\Components\TextInput::make('seoSettings.google_search_console_id')
                            ->label(__('Google Search Console ID')),
                        Forms\Components\TextInput::make('seoSettings.bing_webmaster_tools_id')
                            ->label(__('Bing Webmaster Tools ID')),
                    ])->columns(3),
            ]);
    }
}
