...
import { BannerMap } from "@/Components/Ui/Banner";
...
export function Navigation() {
	...
	return (
		<aside className="w-full border-r bg-background/50 p-4 space-y-6">
			<BannerMap banners={siteStore.getBanner("site::navigation-start")}></BannerMap>
			{/* Navigation Links */}
			...
			<BannerMap banners={siteStore.getBanner("site::navigation-end")}></BannerMap>
		</aside>
	);
}
