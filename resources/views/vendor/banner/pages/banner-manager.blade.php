<x-filament-panels::page>
    <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="space-y-2 font-medium text-sm h-64 xl:h-auto overflow-y-scroll">
                        @foreach ($banners as $banner)
                            <div
                                ...
                                @class([
                                    'rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 transition dark:active:bg-gray-700 active:bg-gray-200 active:shadow-inner hover:transition-all dark:ring-white/10 px-4 py-4 select-none cursor-pointer',
                            ...
                            >
                                ...
                                <div class="flex item-center mt-1">
                                    ...
                                    ></div>
                                    <div class="text-xs text-gray-400 ms-1">
                                        @if ($banner->is_active)
        ...
        <div class="col-span-full xl:col-span-8">
            ...
            @else
                <div class="h-64 bg-gray-100 dark:bg-gray-900 shadow-inner rounded-lg flex items-center justify-center p-4">
