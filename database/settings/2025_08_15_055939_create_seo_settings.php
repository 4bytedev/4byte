...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('SeoSettings.google_analytics_id');
        $this->migrator->add('SeoSettings.google_search_console_id');
        $this->migrator->add('SeoSettings.bing_webmaster_tools_id');
    }
};
